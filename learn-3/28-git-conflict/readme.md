...
In [exercise 15](/learn-2/15-git-merge) you created and merged a pull request to change the links to `orangered`. But your boss is still not happy. She wants to try a purple colour (`fuchsia`).
...
In [exercise 15](/learn-2/15-git-merge) you merged a branch into `master` using GitHub. This time we'll do the same thing on the command line.
...
```
Auto-merging learn-3/20-git-conflict/styles.css
CONFLICT (content): Merge conflict in learn-3/20-git-conflict/styles.css
Automatic merge failed; fix conflicts and then commit the result.
```

This tells you that there is a merge conflict in the file `learn-3/20-git-conflict/styles.css`. If you open the file you will find that lines have been added to the file.
...
```
git add learn-3/20-git-conflict/styles.css
